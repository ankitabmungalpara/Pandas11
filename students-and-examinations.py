...
# The approach first counts the number of times each student has attended an exam per subject.  
# Then, it creates all possible combinations of students and subjects using a cross join.  
# Finally, it merges the count data with these combinations, fills missing values with zero, and sorts the output.  
